            ...
            <div className="card service-card m-2" data-aos="fade-up" data-aos-delay="400">
              <div class="overlay overlay-text">
                <p className="text-white">
                  ...
                  operators and technicians. We possess hand operated augers, mechanically/hydraulically operated
                  rotary rigs with necessary standard drilling tools to make shallow/deep borings as well as in-situ tests
                  in all kinds of subsurface stratum. We have sufficient equipment to carry out major geotechnical
                  investigations for solar power plants, heavy industry, commercial and housing projects, highways,
                  railway &amp; metro projects, etc.
                </p>
                <p className="text-white">
                  Our capabilities include:
                  Drilling Boreholes through Soil and Rock using rotary drilling rig to 30-100 m depth
                  Conducting Dynamic Cone Penetration Test
                  Conducting Packer Test
                </p>
              </div>
            ...
            <div className="card service-card m-2" data-aos="fade-up" data-aos-delay="400">
              <div class="overlay">
                <p className="text-white overlay-text" >
                  ...
                  detecting utilities and voids, site characterization etc.
                </p>
              </div>
      ...
      <div className="row mb-2">
        ...
        <div className="col col-12 col-md-6" data-aos="fade-up" data-aos-delay="400">
          <div className="card service-card m-2">
            <div class="overlay">
              <p className="text-white overlay-text">
                In the current climate of Limited funding and deteriorating pavement conditions, the monitoring,
                maintenance, and cost-effective, innovative rehabilitation of road pavements is of vital importance.
                “CMTL” has all the required facilities to carry out field testing, mix design and evaluations for sub-
          ...
          <div className="card service-card m-2">
            <div class="overlay">
              <ul className="text-white">
                ...
                <li>Field Density Testing by Sand Replacement/Core Cutter Method</li>
              ...
              <ul className="text-white">
                <li>Sampling and testing of quarry material to check its material suitability as per IS/MoRT&amp;H specifications.</li>
              </ul>
            </div>
          ...
          <div className="card service-card m-2">
            <div class="overlay overlay-text">
              <p className="text-white small-text">
                We don’t often pay attention to its existence when it is transferring loads from a structure to the soil
                or bedrock safely and as planned. However, possible shortcomings in the pile design or
                implementation are easy to observe when settlement occurs. Unfortunately, at this point, correcting
                those shortcomings are already too late or, at the very least, expensive.
              </p>
              <p className="text-white small-text">
                A comprehensive testing program is critical to the successful performance of deep foundations.
                CMTL provides a range of highly accurate testing services that are critical in verifying foundation
                design parameters and communicating corrective actions as required.
              </p>
              <p className="text-white small-text">
                Static and Cyclic Plate load tests on soil
                Static Vertical Compression Pile Load Test using kentledge method
                Static Pull out Pile Load Test
                Static Lateral Pile Load Test
                High-strain Dynamic Pile Testing for fast, reliable and cost effective evaluation of foundation bearing
                capacity and structural integrity
                Low-strain Pile Integrity tests to quickly assess structural integrity and length of all types of piles
                Footing load tests using our own, customized load frame arrangement
                Since we are qualified Engineers, we are fully capable of not just carrying out the tests, but also
                validating the test results technically and correlating them to the strata conditions.
              </p>
            </div>
          ...
          <div className="card service-card m-2" data-aos="fade-up" data-aos-delay="400">
            <div class="overlay overlay-text">
              <p className="text-white small-text">
                ...
                through to construction supervision. Early understanding of ground conditions can lead to economies
                in design and construction and prevent cost and time overruns.
              </p>
              <p className="text-white small-text">
                We pride ourselves on the ability to offer clients practical, cost-effective and innovative solutions.
                Our teams of geotechnical engineers and civil engineers have a wealth of experience in different
                industry segments which ensures greater reliability on all parameters.
              </p>
              <p className="text-white small-text">
                ...
                <ul className="text-white">
                  ...
                  <li>Designing of ground improvement techniques in weak soil conditions</li>
      ...
      <div className="row mb-2">
        ...
        <div className="col col-12 col-md-6" data-aos="fade-up" data-aos-delay="400">
          <div className="card service-card m-2">
            <div class="overlay overlay-text">
              <p className="text-white">
                CMTL has a fully-fledged laboratory with facilities for testing soil, rock, bitumen, hardened Concrete
                and almost building material samples. Our laboratory team members are well-trained to handle the
                state-of-art testing equipment. We can also provide on-site laboratory services for major projects.
              </p>
              <p className="text-white">
                We are committed to providing reliable and accurate test results to our customers, along with
                technically correct interpretations. Our laboratory has facilities for carrying out testing of construction
                materials as per BIS/ASTM/BS/EN/MORT&amp;H/NHAI/RAILWAY/CPWD/ DRDO specifications
              </p>
          ...
          <div className="card service-card m-2" data-aos="fade-up" data-aos-delay="400">
            <div class="overlay overlay-text">
              <ul className="text-white mt-5">
                ...
                <li>Monitoring of construction activities to ensure Quality construction through continuous supervision and interaction between various agencies involved in the project.</li>
                <li>Setting up a team of engineers at site or carrying out periodic site visits depending on site requirement for quality inspection.</li>
                <li>Furnishing periodic reports on quality aspects to the client.</li>
              </ul>
            </div>
          ...
          <div className="card service-card m-2">
            <div class="overlay overlay-text">
              <ul className="text-white small-text">
                <li>Assessment of quality / strength of RC members through appropriate field tests.</li>
                <li>Assessment of quality / soundness of buildings / structures.</li>
                <li>Feasibility study for construction of additional floors.</li>
                <li>Assessment of Distress / Structural inadequacy and recommending restoration / strengthening measures.</li>
                <li>Assessment of fire damage structures and recommending appropriate strengthening measures.</li>
                <li>Assessment of load carrying capacity of RC members by Performing load test.</li>
                <li>Assessment of load capacity of embedded anchors by performing Pull-out test.</li>
                <li>Performance load test on handrails, brackets, poles, precast elements, staircase etc.</li>
                <li>Tests on welded joints (DPT) / assessment of thickness in structural steel members.</li>
                <li>Performance evaluation tests on low cost new technology buildings /materials.</li>
              </ul>
            </div>
            ...
            <div className="card service-card m-2" data-aos="fade-up" data-aos-delay="400">
              <div class="overlay overlay-text">
                <p className="text-white mt-5">
                  ...
                  corporate sectors &amp; colleges in testing and good construction practice in civil engineering. We also
                  advise in preparation of technical manuals on various relevant topics pertaining to Civil Engineering
                  practice for Construction QAP (Quality assurance plan)
                </p>
              </div>
...
// <Modal show={show} onHide={closeModelOne} className="modal-dialog">
//   <Modal.Header closeButton>
//     <Modal.Title>Geotechnical Investigations</Modal.Title>
//   </Modal.Header>
//     <Modal.Body>
//       <div className="container">
//         <div className="row model-row">
//           <div className="col col-12 col-md-8 small-text">
//             “CMTL” team comprises of several qualified and experienced site engineers/supervisors/drill
//             operators and technicians. We possess hand operated augers, mechanically/hydraulically operated
//             rotary rigs with necessary standard drilling tools to make shallow/deep borings as well as in-situ tests
//             in all kinds of subsurface stratum. We have sufficient equipment to carry out major geotechnical
...
//             <img src={require('../assests/images/model-img-1.jpg')} className="img-fluid" />
//           </div>
//         </div>
...
//     </Modal.Body>
//   <Modal.Footer>
//     <Button variant="secondary" onClick={closeModelOne}>
//       Close
//     </Button>
//   </Modal.Footer>
// </Modal>
